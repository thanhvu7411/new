...
<div class="pxl-image-box pxl-image-box8" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
            ...
            <div class="pxl-item--image">
                ...
                <div class="wrap-image-right">
                    ...
                    <?php if ( !empty($settings['image_3']) ) : ?>
                        <div class="pxl-item--image3">
                            <?php $img_icon  = pxl_get_image_by_size( array(
                                'attach_id'  => $settings['image_3']['id'],
                                'thumb_size' => 'full',
                            ) );
                            $thumbnail_icon    = $img_icon['thumbnail'];
                            echo pxl_print_html($thumbnail_icon); ?>
